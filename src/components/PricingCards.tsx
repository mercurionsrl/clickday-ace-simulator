  ...
  const tiers: PricingTier[] = [
    {
      ...
      features: [
        ...
        { title: 'Possibilità di essere selezionato nel team ClickAce', available: false },
        { title: 'Supporto prioritario', available: false },
        { title: 'Gestione di più utenze', available: false },
      ],
      cta: 'Inizia Gratis'
    },
    {
      ...
      features: [
        ...
        { title: 'Possibilità di essere selezionato nel team ClickAce', available: true },
    ...
    {
      name: 'Azienda',
      monthlyPrice: 'Contattaci',
      annualPrice: 'Contattaci',
      ...
      features: [
        ...
        { title: 'Possibilità di essere selezionato nel team ClickAce', available: true },
        { title: 'Supporto prioritario', available: true },
        { title: 'Gestione di più utenze', available: true },
        { title: 'Gestione dei tempi dei propri cliccatori', available: true },
      ],
      cta: 'Contattaci'
    }
  ];
